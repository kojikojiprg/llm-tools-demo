...
from common.ui import inject_global_css
...
""", unsafe_allow_html=True)
        ...
        active_style = "background:#dbeafe; color:#1d4ed8; font-weight:700;" if is_active else "color:#475569;"
...
""", unsafe_allow_html=True)
    ...
    from tools.minutes_bot.tool import render
    render()

elif key == "contract":
    from tools.contract_bot.tool import render
    render()

elif key == "csv":
    from tools.csv_analysis.tool import render
    render()

elif key == "ga4":
    from tools.ga4_slack.tool import render
    render()

elif key == "anomaly":
    from tools.anomaly_detection.tool import render
    render()

elif key == "rag":
    from tools.rag_system.tool import render
    render()
